...
<script>
    ...
    <div id="dcMain"> <!-- 当前位置 -->
        ...
        <div id="index" class="mainBox" style="padding-top:18px;height:auto!important;height:550px;min-height:550px;">
            ...
            <h3>
    <a href="<?php echo U(GROUP_NAME.'/Article/addcat');?>" class="actionBtn add">
        添加分类
    </a>
    <?php echo ($title); ?>
</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
        ...
        <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                ...
                <td align="left"><?php echo ($vo["lastname"]); ?></td>
                <td><?php echo (date("Y/m/d",$vo["addtime"])); ?></td>
                <td align="center"><?php echo ($vo["sort"]); ?></td>
                <td align="center">
                    <a href="<?php echo U(GROUP_NAME.'/Article/addcat',array('pid'=>$vo['id']));?>">添加子分类</a> |
                    <a href="<?php echo U(GROUP_NAME.'/Article/index',array('cid'=>$vo['id']));?>">查看内容列表</a> |
                    <a href="<?php echo U(GROUP_NAME.'/Article/editcat',array('cid'=>$vo['id']));?>">编辑</a> |
                    <a href="javascript:delCat('<?php echo ($vo["name"]); ?>','<?php echo U(GROUP_NAME.'/Article/delcat',array('cid'=>$vo['id']));?>');">删除</a>
                </td>
